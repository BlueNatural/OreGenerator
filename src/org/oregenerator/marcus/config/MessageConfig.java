...
public class MessageConfig {
	...
	public static void reloadConfig() {
		if(customCC == null) {
		customCC = new File(OreGenerator.plugin.getDataFolder(),"message.yml");
		...
		try {
			Reader defaultFile = new InputStreamReader(OreGenerator.plugin.getResource("message.yml"),"UTF8");
			if(defaultFile != null) {
